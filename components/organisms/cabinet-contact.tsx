...
interface CabinetContactCardProps {
  contact: Database['public']['Tables']['cabinet_contacts']['Row'];
}
...
const CabinetContactCard = ({ contact }: CabinetContactCardProps) => {
  ...
  return (
    <Card className="cursor-pointer p-6 transition-all hover:scale-105 hover:shadow-xl hover:shadow-primary">
